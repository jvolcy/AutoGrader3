...
public class ReportGenerator implements IAGConstant {
    ...
    private final String HEADER_COLOR1 = "blue";      //color of the main header (source file name)
    private final String HEADER_COLOR2 = "green";     //color of sub-headers (test file names)
    private final String ANALYTICS_COLOR1 = "orange"; //color for source file analytics
    private final String ANALYTICS_COLOR2 = "brown";  //color for execution time output
    private final String OUTPUT_COLOR = "black";      //main output color
    private final String ERROR_COLOR = "red";         ///color indicating an error
...
//            summary += "<hr width=\"100%\" align=\"left\">";
    ...
    public void writeReportToFile(String fileName) {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(fileName))) {
            ...
            console("writeReportToFile(): " + e.toString());
        }
    ...
    private void makeHtmlHeader() {
        ...
        document = String.join("\n",
                ...
                "	<meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />",
                "	<title>" + title + "</title>",
                shCore_js,      //add core js script for the SyntaxHighlighter
                shBrushCpp_js,  //add the js script for the c++ syntax highlighter
                shBrushPython_js,   //add the js script for the python syntax highlighter
                shCoreDefault_css,  //add the style sheet for the syntax highlighter
...
//----------  ----------
    ...
    private final String shCoreDefault_css = String.join("\n",
    ...
    private final String shCore_js = String.join("\n",
    ...
    private final String shBrushPython_js = String.join("\n",
            "<script type=\"text/javascript\">",
            "/**",
            " * SyntaxHighlighter",
            " * http://alexgorbatchev.com/SyntaxHighlighter",
    ...
    private final String shBrushCpp_js = String.join("\n",
            "",
            "<script type=\"text/javascript\">",
            "/**",
            " * SyntaxHighlighter",
